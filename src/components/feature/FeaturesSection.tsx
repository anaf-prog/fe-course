...
//                         className="group relative bg-slate-900/30 backdrop-blur-xs border border-slate-800 rounded-xl p-8 hover:border-[#FF6C37]/30 transition-all duration-300 overflow-hidden min-h-[280px] flex flex-col w-full md:w-1/2"
//                       >
